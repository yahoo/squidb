...
dependencies {
    compile 'com.yahoo.squidb:squidb:4.0.0-beta.2'
    compile 'com.yahoo.squidb:squidb-annotations:4.0.0-beta.2'
    compile 'com.yahoo.squidb:squidb-android:4.0.0-beta.2' // For Android projects only
    annotationProcessor 'com.yahoo.squidb:squidb-processor:4.0.0-beta.2'
    // If using the android-apt plugin, this becomes
    // apt 'com.yahoo.squidb:squidb-processor:4.0.0-beta.2'
}
```
