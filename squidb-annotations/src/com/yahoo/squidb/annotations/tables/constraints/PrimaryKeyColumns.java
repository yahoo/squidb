 ...
 * a table model spec class and puts the SQLite constraint at the table level. For single column primary key
 * constraints, users can also target model spec fields with {@link PrimaryKey}.
 */
