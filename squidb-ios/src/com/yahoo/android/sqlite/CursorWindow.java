...
//            recordClosingOfWindow(mWindowPtr);
    ...
    public boolean isNull(int row, int column) {
        return getType(row, column) == ICursor.FIELD_TYPE_NULL;
    }
    ...
    public boolean isBlob(int row, int column) {
        ...
        return type == ICursor.FIELD_TYPE_BLOB || type == ICursor.FIELD_TYPE_NULL;
    }
    ...
    public boolean isLong(int row, int column) {
        return getType(row, column) == ICursor.FIELD_TYPE_INTEGER;
    }
    ...
    public boolean isFloat(int row, int column) {
        return getType(row, column) == ICursor.FIELD_TYPE_FLOAT;
    }
    ...
    public boolean isString(int row, int column) {
        int type = getType(row, column);
        return type == ICursor.FIELD_TYPE_STRING || type == ICursor.FIELD_TYPE_NULL;
    }
...
//                Logger.i(STATS_TAG + ": Created a new Cursor. " + printStats());
////            }
//        }
//    }
//
