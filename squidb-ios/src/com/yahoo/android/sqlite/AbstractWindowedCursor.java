...
public abstract class AbstractWindowedCursor extends AbstractCursor {
    ...
    public boolean isNull(int columnIndex) {
        checkPosition();
        return mWindow.getType(mPos, columnIndex) == ICursor.FIELD_TYPE_NULL;
    }
    ...
    public boolean isBlob(int columnIndex) {
        return getType(columnIndex) == ICursor.FIELD_TYPE_BLOB;
    }
    ...
    public boolean isString(int columnIndex) {
        return getType(columnIndex) == ICursor.FIELD_TYPE_STRING;
    }
    ...
    public boolean isLong(int columnIndex) {
        return getType(columnIndex) == ICursor.FIELD_TYPE_INTEGER;
    }
    ...
    public boolean isFloat(int columnIndex) {
        return getType(columnIndex) == ICursor.FIELD_TYPE_FLOAT;
    }
