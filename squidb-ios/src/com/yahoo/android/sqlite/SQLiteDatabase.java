...
//    }
     ...
     * @see Cursor
     */
    public ICursor query(String table, String[] columns, String selection,
...
//    }
    ...
    public int delete(String table, String whereClause, String[] whereArgs) {
        ...
        try {
            SQLiteStatement statement = new SQLiteStatement(this, "DELETE FROM " + table +
                    (!SqlUtils.isEmpty(whereClause) ? " WHERE " + whereClause : ""), whereArgs);
            try {
    ...
    public int updateWithOnConflict(String table, ValuesStorage values,
        ...
        try {
            ...
            if (!SqlUtils.isEmpty(whereClause)) {
                sql.append(" WHERE ");
...
//                }
    ...
    public interface CursorFactory {
         ...
         */
        ICursor newCursor(SQLiteDatabase db,
